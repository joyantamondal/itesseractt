          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-white containerPadding">
            ...
            >
              ...
              <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                  <button class="btn signInButton text-white font-weight-bold ml-5">
                    Sign in
                  </button>
                </li>
              </ul>
      ...
      <div class="container-fluid banner containerPadding">
        <div class="row">
          <div class="col-md-6 d-flex flex-column align-items-start justify-content-center">
            ...
            {/* free course search button  */}
            <form class="search" action="">
              <input cl type="search" className="btn-free-contact" placeholder="Your Phone Number" required />
              <button type="submit" className="btn-free" >Book Your Free Demo Class</button>
            </form>
          </div>
